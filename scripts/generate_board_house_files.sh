...
#   echo "::debug::${dir##*/}"    # print sud-directory to debug
  ...
  [ -f *.kicad_sch ] && kibot $KICAD_VARIABLES -c ../../Config.kibot.yaml -d ../../Fabrication/${dir##*/} -s drc,erc zip_gerbers
  # Run KiBot generate JLCPCB BOM
  [ -f *.kicad_sch ] && kibot $KICAD_VARIABLES -c ../../Config.kibot.yaml -d ../../Fabrication/${dir##*/} -s drc,erc gen_jlc_bom
  # Run KiBot generate position file
  [ -f *.kicad_sch ] && kibot $KICAD_VARIABLES -c ../../Config.kibot.yaml -d ../../Fabrication/${dir##*/} -s drc,erc position
